package uk.ac.tees.aad.w9569965.memowareapp.login.weather;
...
public class MainActivity2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        search.setOnClickListener(view -> {
            startActivity(new Intent(MainActivity2.this, WeatherActivity.class));
        });
        btnMaps = findViewById(R.id.btnMaps);
        btnMaps.setOnClickListener(view -> {
            Intent mapsIntent = new Intent(MainActivity2.this, MapsActivity.class);
